...
/** Зілля шляху Mother — заготовка: кольори з брендингу, рецептів варіння ще немає. */
public class MotherPotions extends PathwayPotions {
    public MotherPotions(Pathway pathway, IItemResolver itemResolver,
