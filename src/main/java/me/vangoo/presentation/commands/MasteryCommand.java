...
public class MasteryCommand implements CommandExecutor, TabCompleter {
    ...
    public MasteryCommand(BeyonderService beyonderService) {
    ...
    private void showMasteryInfo(Player player, Beyonder beyonder) {
        ...
        player.sendMessage(ChatColor.YELLOW + "Засвоєння: " + ChatColor.GREEN + mastery + ChatColor.WHITE + "/100 ("
                + ChatColor.GREEN + mastery + "%" + ChatColor.WHITE + ")");
    ...
    private void setMastery(Player player, Beyonder beyonder, int value) {
        ...
        try {
            ...
            player.sendMessage(ChatColor.RED + "Не вдалося змінити засвоєння!");
