...
- **Ініціація — дуель** (замінила стару сховищну ініціацію повністю, не депрекейт:
  ...
  Церкви зі stub-доменом шляху (без реалізованих здібностей/рецептів варіння) більше НЕ
  варять і не приймають замовлення зілля (нема рецептів), але й далі можуть ініціювати через
  дуель — сама ініціація незалежна від сховища й рецептів церкви.
