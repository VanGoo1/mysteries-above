...
`glowingentities` 1.4.11, `packetevents-spigot` 2.13.0, `EffectLib` 10.2 і `triumph-gui` 3.1.7
підтримують 1.21.1 нарівні з новішими (перевірено: у мапінгах glowingentities є `1.21.1`, у
`ServerVersion` packetevents — `V_1_21_1`), тож їх не рухаємо.
